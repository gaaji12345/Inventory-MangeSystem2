...
import com.example.demoinvento.enitity.Category;
import com.example.demoinvento.enitity.Product;
import com.example.demoinvento.exeption.NotFoundException;
import com.example.demoinvento.repo.CategoryRepo;
import com.example.demoinvento.repo.ProductRepo;
import com.example.demoinvento.service.ProductService;
...
//            String imagePath = saveImage(imageFile); //use this when you haven't setup your frontend
    ...
    private String saveImage(MultipartFile imageFile) {
        ...
        String uniqueFileName = java.util.UUID.randomUUID() + "_" + imageFile.getOriginalFilename();
